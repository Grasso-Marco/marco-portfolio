            ...
            <CardActions>
                <Stack direction="column"
                    ...
                    {props.youtube !== undefined ?
                        <Button size="large" startIcon={<YouTubeIcon/>}
                                onClick={() => window.open(props.youtube, '_blank')}>Youtube Video</Button> : <></>}
                    {props.liveDemo !== undefined ?
                        <Button size="large" startIcon={<LiveDemoIcon/>}
                                onClick={() => window.open(props.liveDemo, '_blank')}>Live demo</Button> : <></>}
                    {props.pdf !== undefined ?
